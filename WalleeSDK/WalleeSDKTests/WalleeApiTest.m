...
- (void)testHMACMessage {
    ...
    XCTAssertEqualObjects(hexString, authMessage, @" secure string is correct");
}
...
- (void)testHMACKey {
    ...
    XCTAssertEqualObjects(hexKey, encodedKey, " encoded key is correct");
}
...
- (void)testHMACGeneration {
    ...
    XCTAssertEqualObjects(hexMac, mac, "MAC Data is correct");
